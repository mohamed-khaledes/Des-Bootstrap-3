...
let load =window.onload =setInterval(
    function(){
        let loadeingOverlay= document.getElementById("overlay");
        loadeingOverlay.remove();
        document.body.style.cssText="overflow-y:auto;";
        clearInterval(load)
},2000); 
let animationLoad =window.onload =setInterval(
    function(){
